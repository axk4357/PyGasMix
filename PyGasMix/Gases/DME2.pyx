...
cdef void Gas_DME2(Gas*object):
    """
    This function is used to calculate the needed momentum cross sections for DME2 gas.
    """
    ...
    XATT=gd['gas_DME2/XATT']
    YATT=gd['gas_DME2/YATT']
    XVIB3=gd['gas_DME2/XVIB3']
    YVIB3=gd['gas_DME2/YVIB3']
    XVIB4=gd['gas_DME2/XVIB4']
    YVIB4=gd['gas_DME2/YVIB4']
    XVIB5=gd['gas_DME2/XVIB5']
    YVIB5=gd['gas_DME2/YVIB5']
    XVIB6=gd['gas_DME2/XVIB6']
    YVIB6=gd['gas_DME2/YVIB6']
    XEXC=gd['gas_DME2/XEXC']
